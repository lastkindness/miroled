...
if ($selectMargin === 'no-margin'):
    $marginClass = 'buttons_without-margin';
endif;
...
$selectAlign = get_sub_field('select_align');

$alignClass = '';
if ($selectAlign === 'left'):
    $alignClass = 'buttons_left';
endif;

$classBg = '';
if (strtolower($selectBackground) === 'white'):
    $classBg = 'text-page__buttons';
endif;
...
<section class="fade-content buttons <?php echo $marginClass; ?> <?php echo $alignClass; ?>">
    <div class="container">
        <?php if($buttons): ?>
