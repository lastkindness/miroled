...
final class Theme extends Singleton
{
    ...
    public function registerNavMenus()
    {
        ...
        $menus = [
            'main_menu' => esc_html__('Main Menu', TEXTDOMAIN),
            'footer_first' => esc_html__('Footer First', TEXTDOMAIN),
            'footer_second' => esc_html__('Footer Second', TEXTDOMAIN),
            'footer_third' => esc_html__('Footer Third', TEXTDOMAIN),
        ];
    ...
    {
        $location =['main_menu', 'footer_first', 'footer_second', 'footer_third']; //Add menus location to this array
        if(in_array($args['theme_location'],$location)){
            $args['container']  = '';
            $args['menu_class'] = '';
        }
        return $args;
